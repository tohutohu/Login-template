...
const DB_USER = process.env.MONGODB_USERNAME || 'root';
...
module.exports = {
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'hacku',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'CocoroNiIke',
  },
